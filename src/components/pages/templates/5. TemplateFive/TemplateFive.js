    ...
    render() {
        ...
        return (
            <main id="template_one" className="overview">
                <section className="header" style={{background: "url(https://images.pexels.com/photos/533646/pexels-photo-533646.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260)"}}>
                    <div className="container">
                        <div className="row" style={{width: "100%"}}>
                            <Features title="Background - Industry" flow={flow} style={{width: "100%"}}/> 
                        </div>
                    </div>
                </section>
            </main>
